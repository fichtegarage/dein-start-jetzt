    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-16 max-w-2xl">
        ...
        <p className="text-sm text-muted-foreground mb-10">
          Website jakob-neumann.net · Stand: 6. Juni 2025 · Version 2
        </p>
        ...
        <section className="space-y-10 text-foreground leading-relaxed">
          ...
          <div>
            ...
            <p>Beim Aufrufen dieser Website werden automatisch Informationen durch den Hosting-Anbieter (siehe Ziffer 7) erfasst. Diese sogenannten Server-Logfiles umfassen:</p>
          ...
          <div>
            ...
            <p className="mt-2"><strong>Speicherung und Versand:</strong> Die über das Formular übermittelten Daten werden in einer Datenbank gespeichert (Anbieter: Supabase, siehe Ziffer 7) und zusätzlich zur Benachrichtigung als E-Mail an mich versandt. Der Versand der Benachrichtigung erfolgt über den Dienstleister Resend; der Empfang in meinem Postfach unter der Domain jakob-neumann.net läuft über das E-Mail-Routing von Cloudflare (beide siehe Ziffer 7). Dabei erfolgt eine Übermittlung in die USA (siehe Ziffer 8).</p>
          ...
          <div>
            <h2 className="text-lg font-semibold mb-2">5. Keine Terminbuchung auf dieser Website – Hinweis zur App „Coach Hub"</h2>
          ...
          <div>
            <h2 className="text-lg font-semibold mb-2">6. SSL-/TLS-Verschlüsselung</h2>
          ...
          <div>
            <h2 className="text-lg font-semibold mb-2">7. Hosting und eingesetzte Dienstleister (Auftragsverarbeiter)</h2>
            ...
            <ul className="list-disc pl-6 mt-4 space-y-3">
              <li><strong>Vercel Inc.</strong> (340 S Lemon Ave #4133, Walnut, CA 91789, USA) – Hosting und Auslieferung der Website. Inhalte werden zur Beschleunigung über ein Content-Delivery-Netzwerk mit europäischen Edge-Standorten ausgeliefert; Vercel ist ein US-Unternehmen (siehe Ziffer 8).</li>
              ...
              <li><strong>Resend (Plus Five Five, Inc.)</strong> – Versand der Kontaktformular-Benachrichtigungen per E-Mail (transaktionaler E-Mail-Dienst, USA; siehe Ziffer 8).</li>
              <li><strong>Cloudflare, Inc.</strong> (101 Townsend Street, San Francisco, CA 94107, USA) – Domain-Name-System (DNS) und E-Mail-Routing. Cloudflare betreibt die Nameserver der Domain (Auflösung von jakob-neumann.net zu IP-Adressen) und empfängt eingehende E-Mails an Adressen der Domain, die anschließend an mein E-Mail-Postfach weitergeleitet werden. Dabei verarbeitet Cloudflare insbesondere die IP-Adresse der anfragenden Person sowie bei eingehenden E-Mails Absenderadressen, Header und Inhalte temporär. Cloudflare ist ein US-Unternehmen (siehe Ziffer 8).</li>
            </ul>
          </div>

          <div>
            <h2 className="text-lg font-semibold mb-2">8. Datenübermittlung in Drittländer (USA)</h2>
          ...
          <div>
            <h2 className="text-lg font-semibold mb-2">9. Schriftarten (Webfonts)</h2>
          ...
          <div>
            <h2 className="text-lg font-semibold mb-2">10. Cookies und Reichweitenmessung</h2>
          ...
          <div>
            <h2 className="text-lg font-semibold mb-2">11. Speicherdauer</h2>
          ...
          <div>
            <h2 className="text-lg font-semibold mb-2">12. Keine automatisierte Entscheidungsfindung</h2>
          ...
          <div>
            <h2 className="text-lg font-semibold mb-2">13. Deine Rechte</h2>
          ...
          <div>
            <h2 className="text-lg font-semibold mb-2">14. Aktualität und Änderung dieser Datenschutzerklärung</h2>
