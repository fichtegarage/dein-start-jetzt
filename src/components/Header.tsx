      ...
      <div className="container">
        <div className="flex items-center justify-between h-16 md:h-18">
          ...
          <Button
            ...
            className="hidden lg:inline-flex h-9 px-5 text-[13px] font-medium rounded-full"
          >
            Kontakt
          </Button>
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <nav className="lg:hidden py-6 animate-fade-in absolute top-full left-0 right-0 bg-background/95 backdrop-blur-xl border-b border-border shadow-soft-lg">
            <div className="container flex flex-col gap-1">
              {navItems.map((item) => (
                <a
                  ...
                  className="py-3 px-4 text-base font-medium text-foreground hover:text-muted-foreground rounded-xl transition-colors"
                >
                  {item.label}
                </a>
              ))}
